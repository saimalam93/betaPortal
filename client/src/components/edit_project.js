...
//       setOldProject(result.data.viewSingleProject);
//       console.log(result.data.viewSingleProject);
//     });
//   }; // end of loadData
...
//                 <TableCell style={{ color: "#ffffff" }}>Project Manager</TableCell>
...
//                   type="text"
//                   name="projectManager"
//                   value={oldProject.projectManger}
